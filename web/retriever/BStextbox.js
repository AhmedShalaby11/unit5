class textbox {
    ...
    constructor(id,textboxid,textboxtype,textboxlabelFor,textboxtitle,textboxdesc,textboxplaceholder,textClass,textng) {
        // === Input Paramaters ===
    ...
    create_textbox()
    {
        ...
        var com = " <div style='text-align:left;' id='" + this.textboxid + "'  class='form-group'><label  for='" + this.textboxlabelFor + "'>" + this.textboxtitle + " </label><input "+this.textng+" type='" + this.textboxtype + "' class='form-control "+this.additionalClass+"'  placeholder='" + this.textboxplaceholder + "'><small id='emailHelp' class='form-text text-muted'>" + this.textboxdesc + "</small></div>";
        var element = $("#" + this.id + "");
        element.append(com);
